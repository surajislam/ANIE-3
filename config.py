...
OWNER_USERNAME = getenv("OWNER_USERNAME", "MR_D_BLACK_DEMON")
BOT_USERNAME = getenv("BOT_USERNAME", "ORVIA_X_MUSIC_BOT")
BOT_NAME = getenv("BOT_NAME", "『 𝑶𝑹𝑽𝑰𝑨 X  𝑴𝑼𝑺𝑰𝑪 』")
...
OWNER_ID = int(getenv("OWNER_ID", 7314378545))

# Heroku deployment settings - Refer to Heroku documentation on how to obtain these
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME")
HEROKU_API_KEY = getenv("HEROKU_API_KEY")
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/surajislam/ANIE-3")
